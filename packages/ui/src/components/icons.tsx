...
export const Icons = {
  Activity: twx(Activity).transientProps(["size", "variant"])<IconProps>(
  ...
  Apple: twx(Apple).transientProps(["size", "variant"])<IconProps>(
    ({ size, variant }) => iconVariants({ size, variant }),
  ),
  ...
  ArrowUpRight: twx(ArrowUpRight).transientProps([
    "size",
    "variant",
  ])<IconProps>(({ size, variant }) => iconVariants({ size, variant })),
  ...
  Users: twx(Users).transientProps(["size", "variant"])<IconProps>(
    ({ size, variant }) => iconVariants({ size, variant }),
  ),
